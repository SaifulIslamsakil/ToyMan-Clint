...
const PopularInStore = () => {
    return (
        <div className="  space-y-10 bg-slate-50 py-10">
            ...
            <div className=" w-full h-96 " style={{ backgroundImage: "url(https://i.ibb.co/hB0gq1s/Baby-Moo-New-Collection-Web-9e8176f1-a956-452f-b27a-a7abcae0ffd1.webp)", backgroundSize: "cover", backgroundPosition: "center" }} >
