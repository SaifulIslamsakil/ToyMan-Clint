...
const Navbar = () => {
    ...
    const manu = <>
        ...
        <li><Link to={'/Shop'} className=" hover:bg-sky-400 lg:hover:bg-white hover:text-white p-2 block rounded-lg lg:hover:text-sky-400 hover:border-b-2 hover:border-sky-400" >Shop</Link></li>
    ...
    return (
        <nav>
            ...
            <div className=" px-8 py-5 bg-slate-50 flex justify-between items-center border-b-2 ">
                <Link to={'/'}><img className=" cursor-pointer" src={logo} alt="" /></Link>
            ...
            <div className=" hidden lg:flex items-center justify-between p-8 relative   ">
