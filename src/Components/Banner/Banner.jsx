    ...
    return (
        <div className=" space-y-7">
            ...
            <div className=" w-11/12 mx-auto lg:flex gap-5 justify-between items-center font-semibold text-white space-y-5">
                ...
                <div className=" lg:flex-1 h-72 flex items-center" style={{backgroundImage:"url(https://i.ibb.co/h9V7kJT/bnr3.webp)", backgroundSize:"cover", backgroundPosition:"center"}}>
